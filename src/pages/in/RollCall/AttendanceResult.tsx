...
const AttendanceResult: FC<IProps> = ({ showFilter }) => {
    ...
    const [GetRollCall, { loading: rCLoading, data: rCData }] = useLazyQuery(ROLL_CALL, {
        ...
        onCompleted: (data) => SetActiveRecord(data?.GetClassRollCallAttendances.docs[0]),
    });

    // Get Class
    const [GetClass, { loading: cLoading, data: cData }] = useLazyQuery(GET_CLASSES);
                                                ...
                                                <div className="user-w">
                                                    <div className="user-avatar-w">
                                                        <div className="user-avatar">
                                                            <img alt="" src={cData?.GetClass.doc.form_teacher?.image} />
                                                        </div>
                                                    </div>
                                                    <div className="user-name">
                                                        <h6 className="user-title">{cData?.GetClass.doc.form_teacher?.name}</h6>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-4">
                                                        <a className="element-box el-tablo no-bg bg-ivory mb-0" href="#">
                                                            ...
                                                            <div className="value">{activeRecord.device?.name}</div>
                                                        </a>
                                                    </div>
                                                </div>
                                            )}
                                            ...
                                            <div className="text-center element-box no-bg no-shadow no-padding">
                                                ...
                                                <div className="table-responsive">
                                                    <table className="table table-striped">
                                                        ...
                                                        <tbody>
                                                            {activeRecord.attendances.map((att: any, index: number) => (
                                                                <tr>
                                                                    <td>{index + 1}</td>
                                                                    <td className="text-left">{att.student?.full_name}</td>
                                                                    <td>
