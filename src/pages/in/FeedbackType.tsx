                        ...
                        <div className="content-box">
                            <div className="element-wrapper">
                                <span className="element-actions">
                                    <button className="btn btn-primary " data-target="#NewFeedbackTypeModal" data-toggle="modal" type="button">
                                        Create New
                                    </button>
                                </span>
                            ...
                            <form>
                                <div className="row">
                                    <div className="col-12">
                                        <IconInput placeholder="Enter feedback type" label="Name" icon="os-icon-phone" required={true} type="text" onChange={(name: string) => {}} />
                                    </div>
                                </div>
