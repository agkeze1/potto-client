                        ...
                        <div className="element-box">
                            <div className="row justify-content-center">
                                <div className="col-lg-12">
                                    <AlertMessage message={searchMsg?.message} failed={searchMsg?.failed} />
                                    ...
                                    <div className="tab-content">
                                        ...
                                        <div className="tab-pane" id="subjects">
                                            <div className="text-center element-box no-bg no-shadow">
                                                ...
                                                <AlertMessage message={subMessage?.message} failed={subMessage?.failed} />
                                            </div>
                                        </div>
                                                                    ...
                                                                    {activeStudent.guardians.map((guard: any) => (
                                                                        <div className="col-sm-3">
                                                                            <div className="element-box no-bg">
                                                                                ...
                                                                                />
                                                                                <hr />
                                                                                <a href="#" data-dismiss="modal" data-target="#imageModal" data-toggle="modal">
                                                                                    {guard?.full_name}
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    >
                                                                        <div className="row mb-3">
                                                                            ...
                                                                            <div className="col-sm-6">
                                                                                ...
                                                                                <AlertMessage message={gTMessage?.message} failed={gTMessage?.failed} />
                                                                        ...
                                                                        <AlertMessage message={nGMessage?.message} failed={nGMessage?.failed} />
