      ...
      <div className="row fade-in">
        <div className="col-sm-12 col-md-4">
          <div
            ...
            aria-live="polite"
          >
            showing <strong>{getPageNumber()}</strong> to{" "}
            <strong>{getPageNumber() + length - 1}</strong> of{" "}
            <strong>{totalDocs}</strong> entires
          </div>
        </div>
                  ...
                  <li key={item}>
                    <button
                      ...
                      className={`btn page-item ${
                        page === item + 1 ? "btn-primary" : "btn-default"
                      }`}
                    >
                      {item + 1}
                    </button>
              ...
              {makeArrayFromDocs().length > maxPage && (
                <li>
                  <button
                    tabIndex={0}
                    className={`btn ${
                      page > maxPage ? "btn-primary" : "btn-default"
                    }`}
                  >
