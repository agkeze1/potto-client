...
const GuardianProfile: FC<IProps> = ({ history, match }) => {
  ...
  const { loading: gTypeLoading, refetch: gTRefetch } = useQuery(
    GET_GUARDIAN_TYPES,
    {
      onError: (err) => {
              ...
              {guardian && (
                <div className="element-box ">
                  ...
                  <div className="text-center mb-5 mt-3">
                    ...
                    <h6 className="up-sub-header text-uppercase text-primary">
                      {guardian.type?.name}
                    </h6>
                  </div>
