                                ...
                                <table className="table table-striped text-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>
                                                21st Jan. 2020 -<span className="text-primary"> (3:45pm)</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>
                                                29st Jan. 2020 -<span className="text-primary"> (5:14pm)</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            <td>
                                                6th Feb. 2020 -<span className="text-primary"> (1:02pm)</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
