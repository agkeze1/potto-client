...
import { GET_LEVELS, NEW_LEVEL, UPDATE_LEVEL, REMOVE_LEVEL } from "../../queries/Level.query";
...
const Level: FC<IProps> = ({ history }) => {
    ...
    const [RemoveLevel, { loading: rLoading }] = useMutation(REMOVE_LEVEL, {
        ...
        update: (cache, { data }) => {
            ...
            const index = q.GetLevels.docs.findIndex((i: any) => i.id === data.RemoveLevel.doc.id);
    ...
    const [UpdateLevel, { loading: uLoading }] = useMutation(UPDATE_LEVEL, {
        ...
        update: (cache, { data }) => {
            ...
            const index = q.GetLevels.docs.findIndex((i: any) => i.id === data.UpdateLevel.doc.id);
                                            ...
                                            <div className="element-box-tp">
                                                <div className="table-responsive">
                                                    <table className="table table-padded">
                                                        ...
                                                        <tbody>
                                                            {data.GetLevels.docs.map((level: any, index: number) => (
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td className="row-actions text-center">
                                                                        ...
                                                                        <a
                                                                            ...
                                                                            onClick={async () => {
                                                                                ...
                                                                                let del = window.confirm(`Are you sure you want to delete "${level.name}"?`);
                                                                                if (del) {
                                                                                    await RemoveLevel({
                                                                                        variables: {
                                                                                            id: level.id,
