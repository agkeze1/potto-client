...
import { NEW_TIMETABLE, GET_CLASS_TIMETABLE } from "../../queries/Timetable.query";
                                        ...
                                        {daySet && (
                                            <>
                                                ...
                                                <div className="element-box">
                                                    ...
                                                    <AlertMessage message={pMessage?.message} failed={pMessage?.failed} />
                                                                                ...
                                                                                {prd.break ? (
                                                                                    ...
                                                                                    <>
                                                                                        <span className="text-danger">
                                                                                            <br />
                                                                                            Taken <b className="text-primary">( ENG )</b>
                                                                                        </span>
                                                                                        <a href="#" className="icon-hdn" title="Remove" onClick={() => {}}>
                                                ...
                                                {showPeriod && (
                                                    <div className="element-box mt-0">
                                                        ...
                                                        <AlertMessage message={nTTMessage?.message} failed={nTTMessage?.failed} />
                                                        <form
                                                            onSubmit={async (e) => {
                                                                e.preventDefault();
                                                        ...
                                                        >
                                                            <div className="row">
                                                                <div className="col-md-6">
                                                                    ...
                                                                    <AlertMessage message={sMessage?.message} failed={sMessage?.failed} />
                                                                </div>
                                                                <div className="col-md-6">
                                                                    {/* Teacher input */}
                                                                    <label>Teacher</label>
                                                                    ...
                                                                    <AlertMessage message={tMessage?.message} failed={tMessage?.failed} />
                                                                </div>
                                                                <div className="col-12 mt-3">
                                ...
                                <div className="col-lg-12">
                                    <div className="element-box">
                                        ...
                                        <div className="table-responsive">
                                            <AlertMessage message={tTMessage?.message} failed={tTMessage?.failed} />
                                            ...
                                            <table className="table table-striped">
                                                ...
                                                <tbody>
                                                    {tTData.GetClassTimetable.docs.map((tTable: any, index: number) => (
                                                        <tr>
                                                            <td>{index + 1}</td>
                                                            <td>{tTable.timetable_list?.period?.from + " - " + tTable.timetable_list?.period?.to}</td>
