                    ...
                    <div className="row">
                      <div className="col-md-6 mb-2">
                        <div className="form-group">
                          <label htmlFor="departmental">
                            Filter Feedback Type
                          </label>
                        ...
                        <table className="table table-padded">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>Suggestion</td>
                              <td>
                                Pls can you include edit on Navigation group.
                              </td>
                              <td>12th Jan. 2020</td>
                              <td>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p>
                ...
                even reason consider logbook redesigns.
              </p>
            </div>
          </div>
        </div>
