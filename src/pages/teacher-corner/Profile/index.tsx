            ...
            <div>
              ...
              <div className="row">
                <div className="col-12 col-md-4">
                  <div
                    className="element-box bg-no bg-white"
                      ...
                      <div className="text-center element-box no-bg no-shadow">
                        <ul className="pro-details">
                          ...
                          <li>
                            ...
                            <b>{cleanDate(teacher.dob, true, false)}</b>
                            <span className="badge badge-primary ml-2 p-1">
                              {GetAge(teacher.dob)}Yrs
                            </span>
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            <b>{cleanDate(teacher.doj, true, false)}</b>
                            <span className="badge badge-primary ml-2 p-1">
                              {GetAge(teacher.doj)}Yrs
                            </span>
                          </li>
                          <li>
                      ...
                      <div className="element-info-with-icon">
                        ...
                        <div className="element-info-text">
                          ...
                          <div className="element-inner-desc">
                            Date of joining and phone number cannot be modified
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          onChange={({ currentTarget: { value } }) =>
                            setEditTeacher({ ...editTeacher, email: value })
                          }
                      ...
                      <div className="form-group">
                        ...
                        <input
                          className="form-control"
                          value={new Date(teacher.doj).toDateString()}
                          id="doj"
                          disabled={true}
                          type="text"
                        />
                      ...
                      <div className="form-group">
                        ...
                        <textarea
                          ...
                          onChange={({ currentTarget: { value } }) =>
                            setEditTeacher({ ...editTeacher, address: value })
                          }
                          id="address"
                          className="form-control"
                          rows={2}
