...
import { GET_CLASSES, NEW_CLASS, REMOVE_CLASS, UPDATE_CLASS } from "../../queries/Class.query";
...
const Class: FC<IProps> = ({ history }) => {
            ...
            if (data.GetTeachers) {
                SetTeachers(
                    data.GetTeachers.docs.map((teacher: any) => ({
                        label: teacher.first_name + " " + teacher.middle_name + " " + teacher.last_name + " ( " + teacher.phone + " )",
                        value: teacher.id,
                    }))
                );
            }
    ...
    const [RemoveClass, { loading: rLoading }] = useMutation(REMOVE_CLASS, {
        ...
        update: (cache, { data }) => {
            ...
            const index = q.GetClasses.docs.findIndex((i: any) => i.id === data.RemoveClass.doc.id);
    ...
    const [UpdateClass, { loading: uLoading }] = useMutation(UPDATE_CLASS, {
        ...
        update: (cache, { data }) => {
            ...
            const index = q.GetClasses.docs.findIndex((i: any) => i.id === data.UpdateClass.doc.id);
    ...
    const FormTeacher = (formTeacherObj: any) => {
        if (formTeacherObj) {
            return formTeacherObj.first_name + " " + formTeacherObj.middle_name + " " + formTeacherObj.last_name + " ( " + formTeacherObj.phone + " )";
        } else {
            return null;
        }
    };
                        ...
                        <div className="element-box">
                            ...
                            <div className="row justify-content-center">
                                <div className="col-lg-12">
                                    ...
                                    <AlertMessage message={nMessage?.message} failed={nMessage?.failed} />
                                    <form
                                        onSubmit={async (e) => {
                                            e.preventDefault();
                                    ...
                                    <div className="element-box-tp">
                                        <div className="table-responsive">
                                            <table className="table table-padded">
                                                ...
                                                <tbody>
                                                    {data.GetClasses.docs.map((clas: any, index: number) => (
                                                        <tr key={index}>
                                                            <td>
                                                                <strong>{index + 1}</strong>
                                                            </td>
                                                            <td>{clas.name}</td>
                                                            <td>{FormTeacher(clas.form_teacher) || <span className="text-danger">None assigned!</span>}</td>
                                                            ...
                                                            <td className="row-actions text-center">
                                                                ...
                                                                <a
                                                                    ...
                                                                    title="Delete"
                                                                    onClick={async () => {
                                                                        let del = window.confirm(`Are you sure you want to delete "${clas.name}"?`);
                                                                        if (del) {
                                                                            await RemoveClass({
                                                                                variables: {
                                                                                    id: clas.id,
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12">
                                        ...
                                        <Select
                                            options={teachers}
                                            value={{
                                                label: editClass.formTeacher?.name || <span className="text-gray">Select...</span>,
