...
import { SEARCH_STUDENTS, REMOVE_STUDENT } from "../../../queries/Student.query";
...
const StudentList: FC<IProps> = ({ history }) => {
    ...
    const { loading: lLoading, data: lData, refetch: refetchLevels } = useQuery(GET_LEVELS, {
    ...
    // Get Students
    const [SearchStudents, { loading, data, fetchMore, refetch: refetchStudents }] = useLazyQuery(SEARCH_STUDENTS, {
