                                    ...
                                    >
                                        <div className="row">
                                            <div className="col-10">
                                                <div className="text-primary">{CLEAN_DATE(rec.date).toUpperCase()}</div>
                                            </div>
                                        </div>
                                    </a>
                                ))}
                    ...
                    {activeAtt && (
                        <div className={hideDate ? "col-12" : "col-md-8"}>
                            ...
                            <div className="element-box bg-white">
                                ...
                                >
                                    Summary ( <b className="text-primary">{CLEAN_DATE(activeAtt.date)}</b> )
                                </h6>
                                {showSummary && (
                                    <div className="row">
                                        {/* Counts */}
                                                ...
                                                {activeAtt.students.map((stu: any, index: number) => (
                                                    <tr>
                                                        ...
                                                        <td className="text-left">
                                                            <img className="avatar img-sm mr-2" src={stu.student?.passport} alt="passport" />
